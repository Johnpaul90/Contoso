namespace ContosoUniversity.Migrations
{
    ...
    public partial class Inheritance : DbMigration
    {
        public override void Up()
        {
            ...
            Sql("INSERT INTO dbo.Person (LastName, FirstName, HireDate,EnrollmentDate, Discriminator, OldId) SELECT LastName, FirstName, null AS HireDate, EnrollmentDate, 'Student' AS Discriminator, ID AS OldId FROMdbo.Student");
        ...
        public override void Down()
        {
            ...
            RenameTable(name: "dbo.Person", newName: "Lecturer");
        }
    }
}
